...
export const CartItem = ({
  ...
  return (
    <li
      className={clsx('relative rounded-lg px-3 pb-3 pt-5 last:mb-0', {
    ...
    >
      ...
      <div className="mb-4 flex flex-row items-start justify-between md:gap-3">
        <div className="flex flex-row items-start gap-1">
          ...
          <label
            htmlFor={idx}
            className="flex h-6 w-6 cursor-pointer items-center justify-center rounded-sm bg-gray-400/40 drop-shadow-md md:h-8 md:w-8 md:rounded-md"
          >
      ...
      <div className="pl-[24px] md:pl-[34px]">
        {/* 가격 */}
        {discount_rate === 0 ? (
          <p className="w-fit text-lg font-bold tracking-tighter text-gray-800">{original_price.toLocaleString('ko-KR')}원</p>
        ) : (
          <div className="justify-content flex flex-row items-center gap-2">
            <p className="text-[16px] font-bold tracking-tighter text-red-600 md:text-lg">{discount_rate * 100}%</p>
